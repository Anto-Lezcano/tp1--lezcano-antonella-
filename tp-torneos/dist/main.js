...
console.log("Validación equipo Manchester City:", futbol.validar(equipoFutbol2));
console.log("Validación equipo Chicago Bulls:", basquet.validar(equipoBasquet1));
console.log("Validación equipo LA Lakers:", basquet.validar(equipoBasquet2));
// Crear partidos con árbitros
const partido1 = new Partido("p1", equipoFutbol1, equipoFutbol2, futbol, arbitro1);
const partido2 = new Partido("p2", equipoBasquet1, equipoBasquet2, basquet, arbitro2);
// Crear torneo
...
try {
    const jugadorDuplicado = new Jugador("1", "Jugador Duplicado", 25, "Delantero");
...
try {
    const partidoInvalido = new Partido("p3", equipoFutbol1, equipoFutbol1, futbol);
